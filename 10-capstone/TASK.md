...
### Опционально: AI assistant

Если прошёл этапы `12-llm-apis` и `13-llm-production`, добавь в workspace эндпоинт «спросить ассистента о задачах» с mock/live LLM и Redis-кэшем ответов.
